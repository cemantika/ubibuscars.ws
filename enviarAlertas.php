...
$id_solicitacao = $_POST["idUsuarioSolicita"];
$alerta = $_POST["alerta"];
...
$query = "INSERT INTO alertas (id_alerta, alerta, ativo, id_usuario, nome_remetente) VALUES (nextval('sq_alertas'),'$alerta',1, $id_solicitacao, '$nome_remetente')";
